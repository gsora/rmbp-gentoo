...
ens9="/sys/devices/pci0000:00/0000:00:1c.4/0000:05:00.0/0000:06:03.0/0000:08:00.0/0000:09:00.0/0000:0a:00.0/net/ens9/statistics"
wlp3s0="/sys/devices/pci0000:00/0000:00:1c.2/0000:03:00.0/net/wlp3s0/statistics"
read ens9_rx < "${ens9}/rx_bytes"
read ens9_tx < "${ens9}/tx_bytes"
read wlp3s0_rx < "${wlp3s0}/rx_bytes"
read wlp3s0_tx < "${wlp3s0}/tx_bytes"

# get time and sum of rx/tx for combined display
time=$(date +%s)
rx=$(( $ens9_rx + $wlp3s0_rx ))
tx=$(( $ens9_tx + $wlp3s0_tx ))
